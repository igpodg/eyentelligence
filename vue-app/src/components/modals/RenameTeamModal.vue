                ...
                <div class="modal-body">
                    <div class="xp-modalhbar">
                        <form>
                            ...
                            <input id="renameTeamField"><br><br>
                            <button type="button" class="btn btn-light" @click="renameTeam">Rename</button>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
export default {
    name: "RenameTeamModal",
    props: {
        name: {
            type: String,
            default: "xpRenameModal"
        }
    },
    methods: {
        renameTeam: function() {
            ...
            let teamId = 0;
            let value = document.getElementById("renameTeamField").value;
